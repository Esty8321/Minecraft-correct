...
# active_players: Dict[str, Set[WebSocket]] = {}#??can I take it from the sessions?
...
# ##??what the mean send_to all I need send it only for the tow users
# ##??can remove it??I need to worry send it to all the players
