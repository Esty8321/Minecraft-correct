...
class MovementService:
    """
    Handles all player movement logic inside the game worls.
    This service is responsible for : moving player inside or between chunks, update both the world state
    """
